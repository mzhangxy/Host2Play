...
# ==============================================================================
RENEW_URLS = [
    "https://host2play.gratis/server/renew?i=58db9531-fbfd-4bea-af70-a87579e474c4",
    # 添加更多链接
]
...
def renew_single_url(url):
    ...
    return success, server_name, old_expire, new_expire, failure_reason
...
def main():
    ...
    for idx, url in enumerate(RENEW_URLS, 1):
        ...
        success, server_name, old_expire, new_expire, failure_reason = renew_single_url(url)
